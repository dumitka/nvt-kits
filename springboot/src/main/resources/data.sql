...
-- DESK
insert into desk (desk_status, tip, x, y, height, width, reserved) values (0, 0.0, 10, 10, 100, 100, false);
insert into desk (desk_status, tip, x, y, height, width, reserved) values (0, 0.0, 10, 80, 50, 50, false);
