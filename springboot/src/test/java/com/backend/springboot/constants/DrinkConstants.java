...
public class DrinkConstants {
    ...
    public static final String DRINK_AMOUNT_UNIT = "l";
    public static final DrinkType DRINK_DRINK_TYPE = DrinkType.HOT_DRINK;

    public static final int ONE_DRINK = 1;
    public static final int ZERO_DRINK = 0;
