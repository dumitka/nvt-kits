...
public class MealPriceConstants {
	...
	//kajgana
	public static MealPrice EXISTING_MEAL_PRICE = MealPrice.builder().id(1).meal(EXISTING_MEAL).deleted(false).price(STARTING_PRICE + 300).build();
	...
	public static MealPrice NEW_MEAL_PRICE = MealPrice.builder().meal(EXISTING_MEAL).price(STARTING_PRICE + 500).deleted(false).build();
	...
	public static MealPrice CHANGED_MEAL_PRICE = MealPrice.builder().id(1).meal(EXISTING_MEAL).price(STARTING_PRICE + 1000).build();
	...
	public static MealPrice MEAL_PRICE1 = MealPrice.builder().id(1).meal(MEAL1).deleted(false).price(STARTING_PRICE + 300).build();
	public static MealPrice MEAL_PRICE3 = MealPrice.builder().id(3).meal(MEAL3).deleted(false).price(STARTING_PRICE + 480).build();
	public static MealPrice MEAL_PRICE4 = MealPrice.builder().id(4).meal(MEAL4).deleted(false).price(STARTING_PRICE + 700).build();
